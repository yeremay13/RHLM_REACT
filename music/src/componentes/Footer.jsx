    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <p>Addres: IES El Rincón, LPGC</p>
          <p>Phone: 658816971</p>
          <p>yeremayaranabetancor@alumno.ieselrincon.es</p>
        </div>
        <div className="footer-section">
          <h3>Follow</h3>
      ...
      <div className="footer-info">
        ...
        <p style={{ textAlign: 'center' }}>Política de Privacidad y Cookies | Condiciones de Venta</p>
      </div>
    </footer>
